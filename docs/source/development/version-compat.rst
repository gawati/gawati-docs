...
.. raw:: html
    ...
    <thead>
        ...
        <tr>
            <td style="border: 1px solid black; text-align:center;">1.0.6</td>
            <td style="border: 1px solid black; text-align:center;">
                    <a href="https://github.com/gawati/gawati-portal-ui/commit/0b5056d">2.0.13</a>
                    </td>
            <td style="border: 1px solid black; text-align:center;">
                    <a href="https://github.com/gawati/gawati-portal-server/commit/108d377">1.0.7</a>
                    </td>
            <td style="border: 1px solid black; text-align:center;">
                    <a href="https://github.com/gawati/gawati-data/commit/5bce37b">1.9</a>
                    </td>
        ...
        <tr>
            <td style="border: 1px solid black; text-align:center;">1.0.5</td>
            <td style="border: 1px solid black; text-align:center;">
                    <a href="https://github.com/gawati/gawati-portal-ui/commit/4c38a40">2.0.10</a>
                    </td>
            <td style="border: 1px solid black; text-align:center;">
                    <a href="https://github.com/gawati/gawati-portal-server/commit/108d377">1.0.7</a>
                    </td>
